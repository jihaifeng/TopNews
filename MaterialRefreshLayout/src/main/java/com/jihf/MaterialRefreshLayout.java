...
public class MaterialRefreshLayout extends FrameLayout {
  ...
  private void init(Context context, AttributeSet attrs, int defstyleAttr) {
    ...
    int waveType = t.getInt(R.styleable.MaterialRefreshLayout_wave_height_type, 0);
    if (waveType == 0) {
    ...
    int colorsId = t.getResourceId(R.styleable.MaterialRefreshLayout_progress_colors, R.array.material_colors);
    ...
    int progressSizeType = t.getInt(R.styleable.MaterialRefreshLayout_progress_size_type, 0);
  ...
  @Override protected void onAttachedToWindow() {
    ...
    if (isSunStyle) {
      ...
      LayoutParams layoutParams =
          new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Util.dip2px(context, hIGHER_HEAD_HEIGHT));
