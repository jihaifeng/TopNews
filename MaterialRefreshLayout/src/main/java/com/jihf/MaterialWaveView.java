...
public class MaterialWaveView extends View implements MaterialHeadListener {
  ...
  @Override public void onComlete(MaterialRefreshLayout br) {
    waveHeight = 0;
  ...
  @Override public void onBegin(MaterialRefreshLayout br) {

  }

  @Override public void onPull(MaterialRefreshLayout br, float fraction) {
  ...
  @Override public void onRelease(MaterialRefreshLayout br, float fraction) {

  }

  @Override public void onRefreshing(MaterialRefreshLayout br) {
