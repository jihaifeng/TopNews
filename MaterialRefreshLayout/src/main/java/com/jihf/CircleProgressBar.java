...
public class CircleProgressBar extends AppCompatImageView implements MaterialHeadListener {
  ...
  @Override public void onComlete(MaterialRefreshLayout materialRefreshLayout) {
    if (mProgressDrawable != null) {
      mProgressDrawable.stop();
    }
  ...
  @Override public void onBegin(MaterialRefreshLayout materialRefreshLayout) {
    setVisibility(View.VISIBLE);
    //        mProgressDrawable.setStartEndTrim(0, (float) 0.75);
  }

  @Override public void onPull(MaterialRefreshLayout materialRefreshLayout, float fraction) {

    mProgressDrawable.setProgressRotation(fraction);
  }

  @Override public void onRelease(MaterialRefreshLayout materialRefreshLayout, float fraction) {

  }

  @Override public void onRefreshing(MaterialRefreshLayout materialRefreshLayout) {
    if (mProgressDrawable != null) {
      mProgressDrawable.start();
    }
  }
