...
public class EmptyLayout extends FrameLayout implements View.OnClickListener {
  ...
  private FrameLayout rlErrorRoot;
  private TextView tvError;
  private ImageView ivError;
  private SpinKitView spinKitLoading;
  private RetryListener retryListener;
  private int emptyStatus = Empty_status.STATUS_LOADING;
  ...
  private void initView() {
    ...
    tvError = getView(R.id.fl_empty_root);
    tvError.setOnClickListener(this);
    ivError = getView(R.id.fl_empty_root);
    ivError.setOnClickListener(this);
    spinKitLoading = getView(R.id.fl_empty_root);
