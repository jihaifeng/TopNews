package com.jihf.topnews.widget.coustom_ratingbar;
...
public class MyRatingBar extends LinearLayout {
  ...
  private ImageView getStarImageView() {
    ...
    LinearLayout.LayoutParams layout =
        new LinearLayout.LayoutParams(Math.round(starImageSize), Math.round(starImageSize));//设置每颗星星在线性布局的大小
