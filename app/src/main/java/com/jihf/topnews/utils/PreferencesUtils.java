...
import com.jihf.topnews.constants.Constants;
...
public class PreferencesUtils {
    ...
    public static String getSavePath(Context context) {
        return getString(context, Constants.SAVE_PATH_KEY, Constants.DEFAULT_SAVE_PATH);
    }
    ...
    public static boolean isShowImageAlways(Context context) {
        return getBoolean(context, Constants.NO_IMAGE_KEY, false);
    }
